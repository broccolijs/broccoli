...
Builder.prototype.regenerate = function (outputDir, callback) {
  var self = this
...
Builder.prototype.registerPreprocessor = function (preprocessor) {
  this.preprocessors.push(preprocessor)
}

Builder.prototype.registerCompiler = function (compilerFunction) {
  this.compilers.push(compilerFunction)
}

Builder.prototype.preprocess = function (callback) {
  var self = this
...
Builder.prototype.compile = function (outputDir, callback) {
  var self = this
