...
function Builder (options) {
  ...
  var tmpBaseDir = options.tmpDir || this.baseDir
...
Builder.prototype.addBroccolifile = function () {
  this.getReader().addBroccolifile(this.baseDir)
  return this
}
  ...
  synchronized(this, function (done) {
    ...
    d.run(function () {
      ...
      setImmediate(function () {
        ...
        self.getReader().read(readerDest, function (err) {
          if (err) {
            finish(err)
            return
          }
