...
function loadBroccolifile () {
  ...
  if (broccolifile == null) {
    // call findup on the successive elements of the list until it's successfull
    var misspellings = ['broccolifile.js', 'Broccollifile.js', 'Brocolifile.js', 'Brocollifile.js']
    var i = 0
    for(; broccolifile == null && i < misspellings.length; i++) broccolifile = findup(misspellings[i])
