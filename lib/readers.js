...
Tree.fromDirectory = function (dir) {
...
function bowerTrees (bowerDir, treeOptions) {
  if (typeof bowerDir !== 'string' && treeOptions == null) {
    // bowerDir is optional
    treeOptions = bowerDir
    bowerDir = null
  }
  if (bowerDir == null) {
  ...
  for (var i = 0; i < directories.length; i++) {
    trees = trees.concat(Tree.fromDirectory(path.join(bowerDir, directories[i])))
  }
