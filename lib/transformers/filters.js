...
function Filter (injector, inputTree) {
  this.injector = injector
  this.inputTree = inputTree
}

Filter.prototype.getCacheDir = function () {
  if (this._cacheDir != null) return this._cacheDir
  return this._cacheDir = temp.mkdirSync({
    prefix: 'broccoli-filter-cache-',
    suffix: '.tmp',
    dir: process.cwd()
  })
}

// Should have a .read method promising destDir
// It reads the inputTree and calls transform
