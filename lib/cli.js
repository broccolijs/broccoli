...
function broccoliCLI () {
  ...
  program.command('serve')
    ...
    .option('-p, --port <port>', 'the port to bind to [4200]', 4200)
    .option('-h, --host <host>', 'the host to bind to [localhost]', 'localhost')
    .option('-lp, --live-reload-port <port>', 'the port to start LiveReload on [35729]', 35729)
