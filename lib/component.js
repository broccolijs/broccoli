...
Component.prototype.withTimer = function (fn) {
  var self = this
  acquireTimer()
  // Don't use .finally here, or releaseTimer will error when it's called at
  // the wrong time, and the original error will be shadowed
  return RSVP.Promise.cast(fn()).then(releaseTimer)
